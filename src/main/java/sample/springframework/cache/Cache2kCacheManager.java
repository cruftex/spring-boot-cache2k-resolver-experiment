...
package sample.springframework.cache;
...
public class Cache2kCacheManager implements CacheManager {
	...
	public Cache getCache(final String name) {
		...
		synchronized (name2cache) {
			...
			org.cache2k.Cache<Object, Object> nativeCache =
					configureCache(Cache2kBuilder.forUnknownTypes().manager(manager), name)
							.build();
			cache = new Cache2kCache(nativeCache);
